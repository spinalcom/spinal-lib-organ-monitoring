...
var ConfigFile = /** @class */ (function () {
    ...
    ConfigFile.prototype.init = function (connect, fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this._loadOrMakeConfigFile(connect, fileName).then(function (file) {
                        _this.file = file;
                        _this._scheduleReInit(file);
                        return file;
                    })];
            });
        });
    };
    ConfigFile.prototype._loadOrMakeConfigFile = function (connect, fileName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            spinal_core_connectorjs_1.spinalCore.load(connect, path.resolve("/etc/Organs/".concat(fileName)), function (file) { return resolve(file); }, function () { return connect.load_or_make_dir("/etc/Organs", function (directory) {
                resolve(_this._createFile(directory, fileName));
            }); });
        });
    };
    ConfigFile.prototype._createFile = function (directory, fileName) {
        var file = new ConfigFileModel_1.ConfigFileModel();
        directory.force_add_file(fileName, file, { model_type: "ConfigFile" });
        return file;
    };
    ConfigFile.prototype._scheduleReInit = function (file) {
        var _this = this;
        cron.schedule('0 /10 * * * *', function () {
            _this._reInitializeFileConfig(file);
        });
    };
    ConfigFile.prototype._reInitializeFileConfig = function (file) {
